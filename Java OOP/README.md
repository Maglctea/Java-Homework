...
* [Главный файл 5 задания](Homework05/Main.java) 

    Создать информационную систему компании, способную управлять работниками и отделами

## Урок 6

* [Главный файл 6 задания](Homework06/Main.java) 

    Доработать программу из [5 задания](Homework05/Main.java), применив в ней SOLID принципы и модель MVP

## Урок 7

* [Главный файл 7 задания](Homework07/Main.py) 

    Перевести программу из [6 задания](Homework06/Main.java) на другой язык (в данном случае на Python)